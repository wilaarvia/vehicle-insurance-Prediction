...
vehicle_model = pickle.load(open('vehicle3_model.sav', 'rb'))
...
if (selected == 'vehicle insurance Prediction'):
    ...
    if st.button('vehicle insurance Test Result'):
        insurance_prediction = vehicle_model.predict([[Gender, Age, Driving_License, Region_Code, Previously_Insured, Vehicle_Age, Vehicle_Damage, Annual_Premium, Policy_Sales_Channel, Vintage]])
